...
import featured from "../../../app/image/icon-featured.png";

import discount1 from "../../../app/image/Featured1.jpg";
import discount2 from "../../../app/image/Featured2.jpg";
        ...
        <div className=" overflow-x-hidden">
          ...
          <div className="pt-5 flex flex-col gap-5">
            ...
            <div className="grid grid-cols-12 gap-5">
              <div className="col-span-6 h-auto transition-transform duration-500 ease-in-out hover:-translate-y-2">
                <Image
                  className="h-auto"
                  src={discount1}
                  width={1200}
